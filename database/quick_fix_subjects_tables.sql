-- =====================================================
-- QUICK FIX: Create missing tables for subjects
...
-- Insert grade levels
INSERT IGNORE INTO `grades` (`id`, `grade_level`, `description`) VALUES
(1, '7', 'Grade 7 - Junior High School'),
(2, '8', 'Grade 8 - Junior High School'),
(3, '9', 'Grade 9 - Junior High School'),
(4, '10', 'Grade 10 - Junior High School');
...
INSERT IGNORE INTO `subjects` (`subject_name`, `subject_code`, `grade_id`, `department_id`) VALUES
...
SELECT 'Grades table created successfully' as status;
SELECT * FROM grades;
