...
try {
    ...
    echo "Creating missing enrollment data tables...\n\n";
    
    // 1. Create enrollment_addresses table (Step 2 - Address Information)
    echo "1. Creating enrollment_addresses table...\n";
    $sql_addresses = "
    ...
    $sql_family = "
    CREATE TABLE IF NOT EXISTS enrollment_family_info (
        id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
        enrollment_id INT(11) UNSIGNED NOT NULL,
    ...
    $sql_shs = "
    CREATE TABLE IF NOT EXISTS shs_enrollment_details (
        id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
        enrollment_id INT(11) UNSIGNED NOT NULL,
    ...
    foreach ($newTables as $tableName) {
        try {
            ...
            if ($fieldCount > 0) {
                echo "✅ $tableName ($fieldCount fields)\n";
            } else {
    ...
    $allEnrollmentTables = [
        ...
        'enrollment_academic_history_new' => 'Academic Background (Working)',
    ...
    echo "\n🎊 SUCCESS! All missing enrollment data tables created successfully!\n";
